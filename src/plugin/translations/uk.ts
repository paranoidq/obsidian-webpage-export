...
export const language: i18n =
{
	...
	exportModal:
	{
		...
		parseEntryAsDirectory: {
			title: "Розбирати файл як каталог",
			description: "Якщо вимкнено, не розбиває вхід за структурою і не генерує дерево файлів у бічній панелі (лише для цього експорту).",
		},
		exportButton: "Експортувати",
		filePicker:
		{
	...
	settings:
	{
		...
		document: {
			...
			info_codeBlockCollapseThreshold: "Блоки коду з більшою кількістю рядків, ніж це значення, згортатимуться за замовчуванням (лише для експорту локальних вебсайтів зі зв'язаними файлами). Встановіть 0 або менше, щоб вимкнути автоматичне згортання."
		},
		sidebars: {
			title: "Бічні панелі",
